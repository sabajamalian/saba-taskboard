...
class TestStagesAPI:
    """Test /api/v1/projects/:project_id/boards/:board_id/stages endpoints"""
    
    @pytest.fixture
    def board(self, auth_client, test_project):
        ...
        board_data = json.loads(response.data)['data']
        board_data['project_id'] = project_id
        return board_data
    
    def test_list_default_stages(self, auth_client, board):
        """Should have 3 default stages"""
        response = auth_client.get(f'/api/v1/projects/{board["project_id"]}/boards/{board["id"]}/stages')
    ...
    def test_create_stage(self, auth_client, board):
        ...
        response = auth_client.post(f'/api/v1/projects/{board["project_id"]}/boards/{board["id"]}/stages',
    ...
    def test_update_stage(self, auth_client, board):
        ...
        stages_resp = auth_client.get(f'/api/v1/projects/{board["project_id"]}/boards/{board["id"]}/stages')
        stage_id = json.loads(stages_resp.data)['data'][0]['id']
        
        response = auth_client.put(f'/api/v1/projects/{board["project_id"]}/boards/{board["id"]}/stages/{stage_id}',
    ...
    def test_delete_empty_stage(self, auth_client, board):
        ...
        # Create new stage
        create_resp = auth_client.post(f'/api/v1/projects/{board["project_id"]}/boards/{board["id"]}/stages',
        ...
        # Delete it
        response = auth_client.delete(f'/api/v1/projects/{board["project_id"]}/boards/{board["id"]}/stages/{stage_id}')
        assert response.status_code == 200
    ...
    def test_delete_stage_with_tasks(self, auth_client, board):
        ...
        auth_client.post(f'/api/v1/projects/{board["project_id"]}/boards/{board["id"]}/tasks',
    ...
    def test_reorder_stage(self, auth_client, board):
        ...
        response = auth_client.put(f'/api/v1/projects/{board["project_id"]}/boards/{board["id"]}/stages/{stage_id}/reorder',
